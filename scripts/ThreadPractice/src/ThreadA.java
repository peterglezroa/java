...
public class ThreadA extends Thread{
	...
	public ThreadA(String name, int maxCount) {
		super();
		this.name = name;
		count = 0;
	...
	public ThreadA(String name, int maxCount, ThreadA friend) {
		super();
		this.name = name;
		count = 0;
		this.MAXCOUNT = maxCount;
	...
	public void run() {
		while(count <= MAXCOUNT) {
			count++;
			System.out.println(name + " counting in thread " + Thread.currentThread().getId() + ": " + count);
